...
<div class="ui top attached tabular menu">
    <a class="item active" data-tab="agregar"><i class="plus icon"></i> Agregar Rol</a>
    <a class="item" data-tab="modificar"><i class="edit icon"></i> Modificar Rol</a>
</div>
